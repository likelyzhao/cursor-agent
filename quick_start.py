...
async def main():
    ...
    attention = 'ego 连续超车'
    save_name = 'ego_overtake_multiple.osc'
    # attention = 'ego 绿灯直行，左侧车辆闯灯，ego 刹停于停止线'
    # save_name = 'ego_overtake_multiple_qwennext.oslk'
    # save_name = 'LeftRunner.oslk'
    ...
    query_carla = '''基于rag_osc/carla_examples文件夹下的例子写一个{}的dsl代码,
                    注意以下一些常见的问题:
    ...
    # query_foretellix = '''基于rag_osc/oslk_example 文件夹下的例子写一个{}的oslk代码,
    #                     注意以下一些常见的问题:
    ...
    #                     5. 不要生成多个 oslk 代码文件，只需要生成一个正确的 oslk 代码文件就可以；
    #                     最终结果保存到当前目录下的{}文件中，不要生成其他文件'''.format(attention,save_name)
    # print(query_foretellix)
